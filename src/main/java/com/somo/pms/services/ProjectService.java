...
public interface ProjectService {
    ...
    ProjectResponse updateProject(String projectId, ProjectRequest request) throws BadRequestException;
    void addUserToProject(String projectId, String userId,String ownerId) throws BadRequestException;
    void removeUserFromProject(String projectId, String userId,String ownerId) throws BadRequestException;
